...
namespace Error
{
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(303, "Семантическая ошибка: отсутствует тип после ключевого слова var"),
		...
		ERROR_ENTRY(307, "Семантическая ошибка: слишком много параметров при вызове функции"),
		...
		ERROR_ENTRY(610, "Синтаксическая ошибка: ошибка в операторе сравнения (ожидается <, >, &, !, ~, @)"),
